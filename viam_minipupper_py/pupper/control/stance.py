...
class StanceController:
    ...
    def position_delta(self, leg_index: int, state, command) -> np.ndarray:
        """Calculate the difference between the next desired body location and
        the current body location
    ...
    def next_foot_location(self, leg_index: int, state, command) -> np.ndarray:
